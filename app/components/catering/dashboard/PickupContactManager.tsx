    ...
    <div className="bg-white rounded-xl shadow-md p-6">
      ...
      {isEditing ? (
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{order.pickupContactName}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{order.pickupContactPhone}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 break-all">{order.pickupContactEmail}</p>
            </div>
          </div>
        </div>
      ) : (
        <div className="text-center py-6">
          ...
          <p className="text-gray-500 mb-4">No pickup contact assigned yet</p>
          <button
            onClick={() => setIsEditing(true)}
