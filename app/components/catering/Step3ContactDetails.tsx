...
export default function Step3ContactInfo() {
  ...
  const calculatePricing = async () => {
    ...
    try {
      ...
      console.log("Promo codes:", promoCode);
      console.log("=====================");
  ...
  const handleApplyPromoCode = async () => {
    ...
    try {
      ...
      if (validation.valid) {
        setPromoCode(promoInput.toUpperCase()); // Automatically replaces any existing code
        setPromoSuccess(
          ...
          <div className="lg:col-span-1">
            <div className="bg-base-200/30 rounded-2xl p-6 border border-base-300 sticky top-4">
              ...
              <div className="mb-6">
                ...
                {promoCode && (
                  <div className="bg-base-100 p-2 rounded-lg border border-base-300 flex items-center justify-between">
