    ...
    if (existingIndex > -1) {
      ...
      setSelectedItems([
        ...selectedItems,
        {
          ...
          unitPrice: Number(menuItem.unitPrice) || 0,
          quantity: Number(menuItem.quantity) || 0,
          totalPrice: Number(menuItem.totalPrice) || (Number(menuItem.unitPrice) * Number(menuItem.quantity)) || 0,
        },
      ]);
    }
  };
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-xs text-gray-600">£{Number(menuItem.unitPrice).toFixed(2)} each</span>
                          </div>
                        </div>
