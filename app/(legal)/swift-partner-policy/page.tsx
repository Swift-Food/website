...
export default function SwiftTermsAndConditions() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl border p-8 mb-8">
          ...
          <div className="space-y-2 text-gray-600">
            ...
            <p><span className="font-medium">Phone number:</span> 07437912217</p>
            <p><span className="font-medium">Address:</span> 251 Gray's Inn Road, London, London WC1X 8QT, England</p>
            <p>
        ...
        <div className="bg-white rounded-xl border p-8 space-y-10">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">1.1</span> We provide a platform where restaurants and other food vendors (Swift Partner) and customers looking to place orders for food, including catering (Swift Customers) can connect and transact through our website and mobile application (Platform).
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="border-l-4 border-primary pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">1.3</span> These Terms are entered into between us and you, together the Parties and each a Party. In these Terms, you or your means (as applicable) the Swift Customer placing an order through the Platform.
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 p-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  <li>anything that would constitute a breach of an individual's privacy or any other legal rights (including uploading private information or Personal Data without an individual's consent);</li>
                  ...
                  <li>using data mining, robots, screen scraping or similar data gathering and extraction tools on the Platform; and</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                <p className="text-gray-700 leading-relaxed">
                  <span className="font-medium">3.1</span> The Platform is a marketplace where you can connect with Swift Partners for food and catering services. We provide the Platform (including hosting and maintaining the Platform) to users, process payments between you and Swift Partners, enable Swift Partners to receive orders, and arrange and provide collection and delivery services (together the Swift Food Services). We will provide the Swift Food Services in accordance with these Terms and all applicable laws, and we warrant to you that the Swift Food Services will be provided using reasonable care and skill.
                </p>
              </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-emerald-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">6.2</span> In consideration for the delivery services we provide, we charge delivery fees (Delivery Fees). The Delivery Fees will be set out on the Platform at the time of you placing an Order Request. The Delivery Fee is payable by you and is retained by us before paying the Listing Fees (minus our service fees) to the Swift Partner.
                </p>
              </div>
              <div className="border-l-4 border-emerald-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-indigo-400 pl-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  ...
                  <li>you comply with all other provisions of these Terms.</li>
                </ul>
              </div>
              <div className="border-l-4 border-indigo-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-purple-400 pl-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  ...
                  <li>neither the User Content nor the posting, uploading, publication, submission or transmission of the User Content or our use of the User Content on, through or by means of our Platform (including on social media) will infringe, misappropriate or violate a third party's Intellectual Property rights, or rights of publicity or privacy, or result in the violation of any applicable law or regulation.</li>
                </ul>
              </div>
              <div className="border-l-4 border-purple-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-gray-400 pl-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  ...
                  <li>there are no legal restrictions preventing you from entering into these Terms; and</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-gray-400 pl-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  <li>any third party services, or any unavailability of the Platform due to a failure of the third party services; and</li>
                  <li>any aspect of your interactions with the Swift Partner including the services offered by the Swift Partner, the description of the services requested or offered, any advice provided, the performance of services (including catering services) or supply of food by the Swift Partner, or the accuracy of allergen information provided by the Swift Partner.</li>
                </ul>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  <li>you agree to indemnify us for any Liability we incur due to (i) any claim (including from any tax authority) for any VAT for which you are responsible that you did not correctly declare or remit to the relevant tax authority, (ii) your breach of the Acceptance and Platform Licence clause (clause 2), and (iii) your breach of the Intellectual Property clause (clause 8) of these Terms;</li>
                  <li>we will have no liability to you for any loss of profit, loss of business, loss of data, business interruption, or loss of business opportunity;</li>
                  <li>a Party's liability for any liability under these Terms will be reduced proportionately to the extent the relevant liability was caused or contributed to by the negligent or unlawful acts or omissions of, or breach of this Agreement, by the other Party; and</li>
                  <li>our aggregate liability for any and all Liability arising from or in connection with these Terms will be limited to 100% of the relevant Listing Fee (or if none are payable, £100).</li>
                </ul>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-red-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">13.2</span> We may terminate these Terms at our discretion, effective immediately, including if we no longer intend to operate the Platform (Termination for Convenience).
                </p>
              </div>
              <div className="border-l-4 border-red-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">13.3</span> These Terms may be terminated upon written notice by a Party (Non-Defaulting Party) if:
                </p>
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  ...
                  <li>the Defaulting Party is bankrupt, goes into liquidation, administration, or receivership, or otherwise suffers a similar insolvency event in any jurisdiction in the world.</li>
                </ul>
              </div>
              <div className="border-l-4 border-red-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-600">
                  ...
                  <li>we will immediately cease providing the Swift Food Services;</li>
                  <li>we will cancel any existing Confirmed Orders and you will lose any Listing Fees and other amounts paid other than where termination is due to our Termination for Convenience, in which case the Listing Fees minus the Delivery Fee will be refunded to you;</li>
                  <li>subject to our obligations to retain certain Personal Data for legal, regulatory, tax or accounting purposes, we will delete your Personal Data on termination of these Terms; and</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.1</span> Assignment: Subject to the below clause 14.2, a Party must not assign or deal with the whole or any part of its rights or obligations under these Terms without the prior written consent of the other Party (such consent is not to be unreasonably withheld).
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.2</span> Assignment of Debt: You agree that we may assign or transfer any debt owed by you to us, arising under or in connection with these Terms, to a debt collector, debt collection agency, or other third party.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.3</span> Contracts (Rights of Third Parties) Act 1999: Notwithstanding any other provision of these Terms, nothing in these Terms confers or is intended to confer any right to enforce any of its terms on any person who is not a party to it.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.4</span> Disputes: Alternative dispute resolution is a process where an independent body considers the facts of a dispute and seeks to resolve it, without you having to go to court. If you are not happy with how we have handled any complaint, you may want to contact the alternative dispute resolution provider we use. You can submit a complaint to The Centre for Effective Dispute Resolution via their website at <a href="https://www.cedr.com/" className="text-primary hover:underline">https://www.cedr.com/</a>. The Centre for Effective Dispute Resolution will not charge you for making a complaint and if you are not satisfied with the outcome you can still bring legal proceedings.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.5</span> Entire Terms: Subject to your consumer law rights, these Terms contains the entire understanding between the Parties and the Parties agree that no representation or statement has been made to, or relied upon by, either of the Parties, except as expressly stipulated in these Terms, and these Terms supersedes all previous discussions, communications, negotiations, understandings, representations, warranties, commitments and agreements, in respect of its subject matter.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.6</span> Force Majeure: Neither Party will be liable for any delay or failure to perform their respective obligations under these Terms if such delay or failure is caused or contributed to by a Force Majeure Event, provided the Party seeking to rely on the benefit of this clause, as soon as reasonably practical, notifies the other party in writing about the Force Majeure Event and the extent to which it is unable to perform its obligations, and uses reasonable endeavours to minimise the duration and adverse consequences of the Force Majeure Event.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.7</span> Further assurance: Each Party must promptly do all things and execute all further instruments necessary to give full force and effect to these Terms and their obligations under it.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.8</span> Governing law: These Terms are governed by the laws of England and Wales. Each Party irrevocably and unconditionally submits to the exclusive jurisdiction of the courts operating in England and Wales and any courts entitled to hear appeals from those courts and waives any right to object to proceedings being brought in those courts.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.9</span> Notices: Any notice given under these Terms must be in writing addressed to us at the details set out at the beginning of these Terms or to you at the contact details you provided when placing your Order Request. Any notice may be sent by standard post or email, and will be deemed to have been served on the expiry of 48 hours in the case of post, or at the time of transmission in the case of transmission by email.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.10</span> Publicity: You agree that we may advertise or publicise the broad nature of our supply of the Swift Food Services to you, including on our website or in our promotional material.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.11</span> Relationship of Parties: These Terms are not intended to create a partnership, joint venture, employment or agency relationship between the Parties.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.12</span> Severance: If a provision of these Terms is held to be void, invalid, illegal or unenforceable, that provision is to be read down as narrowly as necessary to allow it to be valid or enforceable, failing which, that provision (or that part of that provision) will be severed from these Terms without affecting the validity or enforceability of the remainder of that provision or the other provisions in these Terms.
                </p>
              </div>
              <div className="border-l-4 border-gray-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">14.13</span> Third party sites: The Platform may contain links to websites operated by third parties. Unless we tell you otherwise, we do not control, endorse or approve, and are not responsible for, the content on those websites. We recommend that you make your own investigations with respect to the suitability of those websites. If you purchase goods or services from a third party website linked from the Platform, such third party provides the goods and services to you, not us. We may receive a benefit (which may include a referral fee or a commission) should you visit certain third-party websites via a link on the Platform (Affiliate Link) or for featuring certain products or services on the Platform. We will make it clear by notice to you which (if any) products or services we receive a benefit to feature on the Platform, or which (if any) third party links are Affiliate Links.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">15.1</span> Force Majeure Event means any event or circumstance which is beyond a Party's reasonable control.
                </p>
              </div>
              <div className="border-l-4 border-blue-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">15.2</span> Intellectual Property means any copyright, registered or unregistered designs, patents or trade marks, business names, get-up, goodwill, domain names, know-how, inventions, processes, trade secrets or Confidential Information, circuit layouts, software, computer programs, databases or source codes, including any application, or right to apply, for registration of, and any improvements, enhancements or modifications of, the foregoing.
                </p>
              </div>
              <div className="border-l-4 border-blue-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">15.3</span> Liability means any expense, cost, liability, loss, damage, claim, notice, entitlement, investigation, demand, proceeding or judgment (whether under statute, contract, equity, tort (including negligence), misrepresentation, restitution, indemnity or otherwise), howsoever arising, whether direct or indirect and/or whether present, unascertained, future or contingent and whether involving a third party or a Party to these Terms or otherwise.
                </p>
              </div>
              <div className="border-l-4 border-blue-400 pl-4">
                <p className="text-gray-600 leading-relaxed">
                  <span className="font-medium">15.4</span> Personal Data has the meaning given in the Data Protection Act 2018.
                </p>
              </div>
            </div>
          </section>
