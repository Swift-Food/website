    ...
    <section ref={sectionRef} id="aboutus" className="relative w-full flex flex-col">
      <div className="relative w-full aspect-[16/9]">
        ...
        <div className="absolute inset-0 max-lg:hidden flex items-center justify-end py-8 px-4 sm:px-8">
          <div className={`relative z-10 max-w-2xl w-full bg-white rounded-[2.5rem] p-8 sm:p-12 flex flex-col items-center shadow-lg transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <h2
      ...
      <div className="lg:hidden w-full px-4 py-8 bg-base-100">
        <div className={`max-w-2xl mx-auto bg-white rounded-[2.5rem] p-8 flex flex-col items-center shadow-lg transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <h2
