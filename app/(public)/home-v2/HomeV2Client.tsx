...
const SOCIAL_LOGOS: { name: string; src: string; href: string }[] = [
  {
    name: "Cursor",
    src: "/SocialProof/Cursor_logo.svg.png",
    href: "https://cursor.com/",
  },
  {
    name: "Holistic AI",
    src: "/SocialProof/holistic_AI_logo.png",
    href: "https://www.holisticai.com/",
  },
  {
    name: "Cloudflare",
    src: "/SocialProof/Cloudflare_Logo.svg.png",
    href: "https://www.cloudflare.com/",
  },
  { name: "Cornetto", src: "/SocialProof/Cornetto-Logo.png", href: "#" },
  {
    name: "UCL",
    src: "/SocialProof/University_College_London_logo.svg.png",
...
export default function HomeV2Client() {
  ...
  const onPointerDown = useCallback((e: React.PointerEvent) => {
    ...
    const onMove = (ev: PointerEvent) => {
      ...
      offset.current =
        dragStartOffset.current + (ev.clientX - dragStartX.current);
    ...
    <div className="hv2-page-glow relative overflow-x-hidden bg-[#fbf7f4] text-[#1a1a1a]">
      ...
      <section className="relative z-10 mx-auto grid min-h-screen max-w-[1280px] grid-cols-1 content-center items-center gap-10 px-8 pt-[132px] pb-[100px] max-[1100px]:px-8 max-md:gap-4 max-md:pt-20 max-md:pb-16 lg:grid-cols-[1fr_auto] lg:gap-[72px]">
        <div className="max-md:text-center">
          <h1 className="mb-6 text-[clamp(40px,4.6vw,60px)] font-bold leading-[1.06] tracking-[-0.025em] max-md:mb-4 max-md:text-[34px] max-md:leading-[1.1]">
            ...
            <span className="font-medium text-[#fa43ad]">
              zero&nbsp;effort.
            </span>
          </h1>
          ...
          <p className="mb-9 max-w-[490px] text-[19px] leading-[1.5] text-[#4a4845] max-md:mx-auto max-md:mb-4 max-md:text-[13.5px]">
            Tell us what you&apos;re hosting — we&apos;ll suggest the menu,
            price it, and deliver.
          </p>
        ...
        <div className="hv2-iframe-stage relative" aria-hidden="true">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M63 18 L77 18 L83 27 L63 27 Z"
                strokeWidth="1.5"
                strokeLinejoin="round"
              />
      ...
      >
        ...
        <h2 className="mb-[72px] max-w-[720px] text-[clamp(36px,4.2vw,56px)] font-medium leading-[1.06] tracking-[-0.022em] max-md:mb-12 max-md:text-[26px]">
          From{" "}
          <em className="italic text-[#fa43ad]">
            &ldquo;I need lunch for 50&rdquo;
          </em>{" "}
          ...
          {[
            {
              ...
              body: "Headcount, dietary needs, budget, the vibe. A quick chat — no forms, no menus to scroll, no quote requests.",
            },
            {
              num: "02",
              title: "Get a tailored menu",
              body: "Swift suggests dishes from real local kitchens, sized and priced for your crowd. Swap, edit, or approve in one tap.",
            },
            {
              num: "03",
              title: "Confirm and we deliver",
              body: "One tap locks it in. We coordinate the kitchen and the driver — you get on with hosting.",
            },
          ].map(({ num, title, body }) => (
            <div key={num} className={STEP_CARD}>
              ...
              <h3 className="mb-3 text-[23px] font-semibold tracking-[-0.012em]">
                {title}
              </h3>
        ...
        >
          <div>
            <div className={SECTION_EYEBROW}>
              For workspaces, offices &amp; venues
            </div>
            <h2 className="mb-[22px] text-[clamp(36px,4.5vw,56px)] font-medium leading-[1.05] tracking-[-0.022em] max-md:text-[26px]">
              Add <strong className="font-semibold text-primary">Nibble</strong>, our Catering AI to{" "}
              <em className="italic text-[#fa43ad]">your</em> site. In one line.
            </h2>
            <p className="mb-8 max-w-[500px] text-[17px] leading-[1.55] text-[#4a4845]">
              Give members, teams, or guests a way to order catering right from
              your coworking space, office, or venue website.
            </p>
            <ul className="mb-9 flex flex-col gap-3.5">
              {[
                [
                  "Easy to integrate.",
                  "Install the package, drop in the component — minimal code, no complex setup.",
                ],
                [
                  "Your brand, your colours.",
                  "Customise the widget to match your site's look and feel.",
                ],
                [
                ...
                [
                  "Free to get started.",
                  "No setup fee, no monthly cost. Get up and running in minutes.",
                ],
              ].map(([lead, rest]) => (
                <li
                  key={lead}
                ...
                >
                  <strong className="mr-1 font-semibold text-[#1a1a1a]">
                    {lead}
                  </strong>
                  {rest}
                </li>
                    ...
                    <div className="hv2-site-hero relative flex h-full items-end overflow-hidden bg-[linear-gradient(160deg,rgba(15,25,35,0.55),rgba(15,25,35,0.15)),linear-gradient(135deg,#2d4a5e,#1a2e3e)] p-8 text-white">
                      <div className="relative z-10 max-w-[80%]">
                        ...
                        <div className="mb-4 max-w-[280px] text-[13px] leading-[1.4] opacity-90">
                          Hot desks, meeting rooms, and now — team lunches on
                          demand.
                        </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2.5 overflow-hidden p-4 max-md:p-3">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="overflow-hidden rounded border border-[#e8e2da] text-[9px] leading-none">
                          <div className="bg-[#fa43ad] px-2 py-0.5 font-bold tracking-wider text-white">
                            THU
                          </div>
                          <div className="px-2 py-1 text-center text-[13px] font-semibold text-[#1a1a1a]">
                            28
                          </div>
                        </div>
                      ...
                      <div className="flex gap-2 overflow-hidden">
                        {[
                          ...
                          >
                            ...
                            <span className="text-[8px] text-[#4a4845]">
                              {label}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="flex flex-wrap gap-1">
                        {["Halal", "Vegetarian", "Vegan", "Pescatarian"].map(
                          (d) => (
                            <span
                              key={d}
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {[
                          ...
                          >
                            <div
                              className={`h-14 bg-gradient-to-br ${r.from} ${r.to}`}
                            />
                            <div className="px-2 py-1.5">
                              <div className="truncate text-[10px] font-semibold text-[#1a1a1a]">
                                {r.name}
                              </div>
                              <div className="text-[9px] text-[#8a8580]">
                                ★ {r.rating}
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex flex-col gap-2 border-l border-[#f4efe8] bg-[#fafafa] p-3 max-md:hidden">
                      ...
                      <div className="flex gap-1 rounded-md bg-[#f4efe8] p-0.5 text-[9.5px] font-semibold">
                        <button className="flex-1 rounded-md py-1 text-[#8a8580]">
                          Cart
                        </button>
                      ...
                      <div className="flex items-center gap-1.5 pt-1">
                        ...
                        <div className="leading-tight">
                          ...
                          <div className="text-[8.5px] text-[#8a8580]">
                      ...
                      <div className="hv2-menu-preview rounded-lg border border-[#e8e2da] bg-white px-2.5 py-2">
                        ...
                        <div className="mb-2 text-[11px] font-semibold text-[#1a1a1a]">
                          Pizza
                        </div>
                    ...
                    <div className="flex flex-1 flex-col gap-2 overflow-hidden p-3">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="overflow-hidden rounded border border-[#e8e2da] text-[8px] leading-none">
                          <div className="bg-[#fa43ad] px-1.5 py-0.5 font-bold tracking-wider text-white">
                            THU
                          </div>
                          <div className="px-1.5 py-0.5 text-center text-[12px] font-semibold text-[#1a1a1a]">
                            28
                          </div>
                        </div>
                        <div className="flex-1">
                      ...
                      <div className="flex gap-1.5 overflow-hidden">
                        {[
                          ...
                          >
                            ...
                            <span className="text-[7px] text-[#4a4845]">
                              {label}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        {[
                          ...
                          >
                            <div
                              className={`h-12 bg-gradient-to-br ${r.from} ${r.to}`}
                            />
                            <div className="px-1.5 py-1">
                              <div className="truncate text-[9px] font-semibold text-[#1a1a1a]">
                                {r.name}
                              </div>
                              <div className="text-[8px] text-[#8a8580]">
                                ★ {r.rating}
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="hv2-m-chat absolute inset-0 flex flex-col gap-2.5 bg-[#fafafa] p-3">
                    ...
                    <div className="hv2-m-chat-input mt-auto flex items-center gap-2 rounded-full border border-[#e8e2da] bg-white px-3 py-2">
                      <span className="overflow-hidden text-[11px] leading-none text-[#1a1a1a]">
                        <span className="hv2-m-typewriter">
                          suggest some pizza
                        </span>
