        ...
        <div>
          <div className="flex gap-2 mb-3">
            <input
              ...
              className="flex-1 px-3 py-2 text-base bg-gray-100 border border-base-300 rounded-lg focus:ring-2 focus:ring-dark-pink focus:border-transparent transition-all"
            />
            <button
              type="button"
              onClick={handleApply}
